  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        ...
        >
          <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 gradient-text">Relevant Coursework</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {courseworkCategories.map((category, index) => (
            <motion.div 
              key={index} 
              className="bg-white/70 rounded-2xl p-4 md:p-6 hover:bg-white transition-all duration-300 hover-scale shadow-sm"
            ...
            >
              <div className="flex items-center space-x-3 mb-4 md:mb-6">
                ...
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-800">{category.category}</h3>
              </div>
              ...
              <ul className="space-y-3">
                {category.courses.map((course, courseIndex) => (
                  <li key={courseIndex} className="flex items-start space-x-2">
                    ...
                    <span className="text-gray-600 text-sm md:text-base">{course}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-purple-100 rounded-full px-4 md:px-6 py-2 md:py-3">
            ...
            <span className="text-purple-700 font-semibold text-sm md:text-base">Continuously expanding knowledge base</span>
          </div>
        </motion.div>
      </div>
    </motion.section>
